# Hi there, my name is Anna Sokol 👋
...
- **ETL Pipelines:** 🏗️ Building workflows for Extract, Transform, and Load operations.
- **AWS Cloud:** ☁️ Practical experience with **S3** (Data Lakes) and **EC2** (Compute Instances).
- **Infrastructure:** 🐳 **Docker** for containers and 🐚 **Bash/Shell** for automation.
- **Database Design:** 🗄️ Working with SQL schemas and normalization.
...
- **Deep Learning:** 🧠 **CNNs** (Convolutional Neural Networks) & Computer Vision.
- **Data Analysis:** 📊 Advanced data manipulation using Pandas and NumPy.
